...
export const BlogList = () => {
  const {
    ...
    BlogListRequest,
    BlogUpdateRequest,
    BlogAddRequest, // Make sure this exists in your store
  } = BlogStore();
  ...
  const onSaveEdit = async (id) => {
    ...
    const result = await BlogUpdateRequest(id, editFormData);
    if (result) {
  ...
  const onSaveAdd = async () => {
    ...
    const result = await BlogAddRequest(addFormData);
    if (result) {
